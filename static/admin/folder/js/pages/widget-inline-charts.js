...
$(function () {
	...
	$("#sparkline5").sparkline([18, 22, 38, 20], {
        type: 'pie',
        height: '100',
        sliceColors: ['#3aa0dc', '#06d79c', '#745af2', '#fc4b6c'],
  ...
  function drawDocSparklines() {
    ...
    $('#linecustom').sparkline('html',
        {
          height: '1.5em', width: '8em', lineColor: '#fc4b6c', fillColor: '#e9ab2e',
    ...
    $('#discrete2').sparkline('html',
        {type: 'discrete', lineColor: '#3aa0dc', thresholdColor: '#fc4b6c', thresholdValue: 4});
