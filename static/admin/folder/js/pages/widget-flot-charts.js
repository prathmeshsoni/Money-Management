...
$(function () {
    ...
    var interactive_plot = $.plot('#interactive', [getRandomData()], {
	  ...
	  tooltip: true,
      lines : {
        fill : '#fc4b6c', //Converts the line chart to area chart
        color: '#fc4b6c'
      },
	  tooltipOpts: {
            content: "Visit: %y"
    ...
    var donutData = [
      { label: 'Jan-Apr', data: 85, color: '#fc4b6c' },
      { label: 'May-Aug', data: 68, color: '#26c6da' },
      { label: 'Sep-Dec', data: 42, color: '#398bf7' }
    ]
